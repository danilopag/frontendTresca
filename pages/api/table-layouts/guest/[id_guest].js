// pages/api/table_layout/[id_guest].js
import { createHandler } from '../../../../utils/nc';
import db from '../../../../utils/db';
import { authenticateToken } from '../../../../utils/auth';

const handler = createHandler()
    // DELETE /api/table_layout/:id_guest?plan=xxx
    .delete(async (req, res) => {
      ...
      `, [id_guest, plan]);
            ...
            // Decrementa position invitati successivi
            await db.query(`
        UPDATE table_layouts
        SET table_side_position = table_side_position - 1
        WHERE id_table = ? AND table_order = ? AND table_side_position > ? AND plan = ?
